  ...
  return (
    <div className="min-h-screen bg-aged-cream flex items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <button
          onClick={() => reset()}
          className="font-sans text-xs uppercase tracking-widest px-6 py-3 border border-navy/20 hover:bg-navy hover:text-aged-cream transition-colors duration-300"
        >
          Try Again
        </button>
      </div>
