      ...
      <main className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-8 sm:mb-12 px-1 sm:px-0">
          <div className="max-w-xl">
            <p className="font-mono text-[11px] sm:text-[11px] tracking-[0.3em] text-brass mb-4 sm:mb-5">
            ...
            <p className="font-mono text-[11px] tracking-[0.25em] text-graphite/35 mt-5 sm:mt-6 uppercase">
        ...
        <div className="mb-6 sm:mb-8 border-2 border-navy p-3 sm:p-5">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1.5 sm:gap-2">
            <div>
              <p className="font-mono text-[11px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.25em] text-navy font-semibold">
                INVENTORY MANIFEST
              </p>
              <p className="font-mono text-[11px] sm:text-[11px] tracking-[0.12em] sm:tracking-[0.15em] text-graphite mt-0.5 sm:mt-1">
                STATION 45&deg;N <span className="text-brass">&#9670;</span> GHOST FOREST SURF CLUB
              </p>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              <span className="font-mono text-[11px] sm:text-[11px] tracking-[0.15em] sm:tracking-[0.2em] text-brass font-semibold">
                {products.length} ITEMS
              </span>
              {activeCollection !== 'all' && (
                <>
                  <span className="text-brass/40 font-mono text-[11px]">&#9670;</span>
                  <span className="font-mono text-[11px] sm:text-[11px] tracking-[0.12em] sm:tracking-[0.15em] text-signal-red font-semibold">
          ...
          <div className="flex items-center gap-2 mt-2.5 sm:mt-3">
            ...
            <span className="font-mono text-[11px] text-brass/40">&#9632;</span>
            <div className="flex-1 h-px bg-brass/20" />
          </div>
          <p className="font-mono text-[11px] sm:text-[11px] tracking-[0.15em] sm:tracking-[0.2em] text-graphite/50 mt-1.5 sm:mt-2">
        ...
        {loading ? (
          <div className="py-12">
            ...
            <div className="border-2 border-navy/20 p-6 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="font-mono text-[11px] tracking-[0.3em] text-brass animate-pulse">
                  RETRIEVING MANIFEST...
                </p>
                <div className="h-px flex-1 bg-navy/10" />
              </div>
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <span className="font-mono text-[11px] text-navy/30">001</span>
                  <div className="h-2 bg-navy/8 flex-1" />
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-mono text-[11px] text-navy/30">002</span>
                  <div className="h-2 bg-navy/6 w-3/4" />
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-mono text-[11px] text-navy/30">003</span>
          ...
          <div className="border-2 border-navy/20 p-8 text-center">
            <p className="font-mono text-[11px] tracking-[0.25em] text-brass mb-2">&#9670;</p>
            <p className="font-mono text-xs tracking-[0.2em] text-graphite">
              NO ITEMS IN THIS DEPARTMENT
            </p>
            <p className="font-mono text-[11px] tracking-[0.15em] text-graphite/50 mt-1">
                ...
                return (
                  <div key={`divider-${feedIndex}`} className="col-span-1 sm:col-span-2 lg:col-span-3 xl:col-span-4 py-2">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-mono text-[11px] tracking-[0.3em] text-brass/40">
                        CONTINUED
                      </span>
                      <span className="font-mono text-[11px] text-brass/50">&#9670;</span>
                      <div className="flex-1 h-px bg-brass/25" />
          ...
          <div className="mt-8 pt-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-mono text-[11px] text-navy/30">&#9632;</span>
              <div className="flex-1 h-px bg-navy/20" />
            </div>
            <div className="text-center mt-4">
              <p className="font-mono text-[11px] tracking-[0.35em] text-graphite/50">
                &#9670; END OF MANIFEST &#9670;
              </p>
              <p className="font-mono text-[11px] tracking-[0.2em] text-graphite/30 mt-1">
