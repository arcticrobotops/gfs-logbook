    ...
    <footer className="bg-aged-cream mt-12">
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="flex items-center gap-2 sm:gap-3 mb-6 sm:mb-8">
          ...
          <p className="font-mono text-[11px] sm:text-[11px] tracking-[0.25em] sm:tracking-[0.35em] text-brass font-semibold whitespace-nowrap">
            &#9670; OFFICIAL MANIFEST &#9670;
          </p>
          <div className="flex-1 h-px bg-brass/30" />
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {/* Station manifest */}
          <div>
            <p className="font-mono text-[11px] tracking-[0.25em] text-brass mb-3">
              STATION MANIFEST
            </p>
            <p className="font-mono text-[11px] tracking-[0.12em] text-navy leading-relaxed font-semibold">
              GHOST FOREST SURF CLUB
            </p>
            <p className="font-mono text-[11px] tracking-[0.12em] text-graphite mt-1">
              NESKOWIN, OR 97149
            </p>
            <p className="font-mono text-[11px] tracking-[0.12em] text-graphite mt-0.5">
          ...
          <div>
            ...
            <p className="font-mono text-[11px] tracking-[0.12em] text-graphite leading-relaxed">
              LAT: 45.10&deg;N
            </p>
            <p className="font-mono text-[11px] tracking-[0.12em] text-graphite mt-0.5">
              LON: 123.98&deg;W
